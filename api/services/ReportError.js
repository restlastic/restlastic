...
module.exports = {
    ...
    error: function(req, error, error_id) {
      ...
      if (req.headers.authorization) {
        client = jwt.decode(req.headers.authorization, secret).iss || client;
      }
